    ...
    <main>
      <div className={styles.overlayContent}>
        ...
        <p className={styles.fadeIn} style={{ animationDelay: '0.8s' }}>
          ...
          using vanila js and a smart contract in solidity. On front end I used web 3 and on backend
          I used ethereum’s blockchain. The way this application works is that an admin prepares the
