  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.textContainer}>
        <p>
          I’m a Full Stack Developer who loves working with frontend frameworks like Angular and
          React/Next.js, alongside solid backend skills in Node.js (NestJS) and Progress OpenEdge. I
          enjoy crafting complex user interfaces, building full authentication systems, desktop
          apps, and admin dashboards. Clean code and intuitive user experiences are my passion, and
          I’m excited about blending AI and data visualization to create smart, engaging
          applications.
        </p>
      </div>
